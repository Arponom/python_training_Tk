...
class test(unittest.TestCase):
    ...
    def test_test(self):
        ...
        self.create_new_address(wd,firstname='test1', middlename='test2', lastname='test3', nickname='test4', title='test5', company='test6', address='test7',
    ...
    def create_new_address(self, wd, firstname, middlename, lastname, nickname, title, company, address, home, mobile,
                           work, fax, email):
